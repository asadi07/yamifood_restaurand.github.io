...
<body>
	...
	<div class="nav">
		...
		<div class="nav-items">
			<div class="nav-call">
				<img src="images/social-media/call.png"> <span>+880172928197</span>
			</div>
			<div class="nav-btn">
				<a href="singin.php"><button type="button">Login</button></a>
				<a href="registation.php"><button type="button">Sing UP</button></a>
			</div>
			<div class="nav-cart">
		...
		<div class="container">
			<div class="row">
				<div class=" col-lg-6 col-md-12 col-sm-12 col-xs-12" >
					<div class=" about-img">
						<img src="images/stuff-img-03.jpg"  alt="..." class="img-thumbnail">
					</div>
				</div>
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
					<div class="about-txt">
